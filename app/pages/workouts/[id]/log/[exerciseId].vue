<template>
  <CommonBasePage
      v-if="exercise"
      :title="exercise.name"
      :subtitle="exercise.bodyPartName"
  >
    <template #navigation>
      <UiNavigationBackLink :route="backLink">Back to session</UiNavigationBackLink>
    </template>

    <div v-if="exercise" class="workout-log-container">
      ...
      <!-- Log Form -->
      <form @submit.prevent="saveLog" class="mt-4">
